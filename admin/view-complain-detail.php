...
from tblcomtracking where tblcomtracking.ComplainNumber=:comid";
                            ...
                            $cnt = 1;
                          ?>
                            <table id="datatable" class="table table-bordered dt-responsive nowrap" border="1" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                              <tr align="center">
                    ...
                    <input name="Submit2" type="submit" class="txtbox4" value="Print" OnClick="CallPrint(this.value)" style="cursor: pointer;" />
                    <?php
                            ...
                            <table class="table table-bordered table-hover data-tables">
                              ...
                              <form method="post" name="submit">
                                ...
                                <tr>
                                  <th>Assign Date :</th>
                                  <td>
                                    <input type="date" name="assigndate" rows="12" cols="14" class="form-control wd-450" required="true">
                                  </td>
                                </tr>
                                <tr>
                                  <th>Status :</th>
